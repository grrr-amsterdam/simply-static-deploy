...
class RestoreInitialOptionsTask extends Task {
    ...
    public function perform() {
        ...
        $this->options->set('additional_files', f\prop('additional_files', $initialOptions));
        $this->options->set('additional_urls', f\prop('additional_urls', $initialOptions));
        $this->options->set('urls_to_exclude', f\prop('urls_to_exclude', $initialOptions));
        $this->options->save();
